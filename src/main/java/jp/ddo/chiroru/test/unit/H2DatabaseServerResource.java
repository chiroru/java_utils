package jp.ddo.chiroru.test.unit;
...
import jp.ddo.chiroru.utils.PropertyLoader;
...
public class H2DatabaseServerResource
    ...
    public H2DatabaseServerResource() throws IOException {
    ...
    private static class DatabaseProperties {
        ...
        private DatabaseProperties() throws IOException {
            PropertyLoader loader = new ClassPathPropertyLoader();
            props = loader.load(PROPERTY_FILE_PATH);
        }
